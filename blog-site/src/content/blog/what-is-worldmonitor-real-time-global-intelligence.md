...
The public dashboard exposes 56 map-layer types, 500+ curated news feeds backed by 532+ observed upstream hosts, country briefs, instability scores, chokepoints, infrastructure, markets, disasters, and watchlists. Every layer except the Resilience layer is available on the free plan, and the dashboard can be opened without an account.
...
- **26 interface languages**, including right-to-left Arabic
