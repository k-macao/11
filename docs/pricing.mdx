...
| **Pro** | $39.99/month · $359.99/year | WM Analyst chat, Scenario Engine, AI digests, custom widgets, MCP access — personal license |
| **Pro Business** | $49.99/month · $449.99/year | Everything in Pro for client work, internal tools and reporting — data export, 25 dashboards, 250 MCP calls/day, priority support |
...
| **API Business** | $299.99/month | Everything in API Starter, redistribution rights, 300 requests/minute, 10,000 requests/day, 5 Pro licenses included (same company email), priority support |
...
- **Free** — 56 map layers (all free except Resilience, which is Pro), 500+ curated feeds backed by 532+ observed upstream hosts, country briefs, hotspots, instability scores, chokepoints, cascade analysis, breaking alerts, and watchlists, across 3 dashboard tabs. Dashboard refresh cadence is typically 5–15 minutes.
- **Pro** — everything in Free, plus WM Analyst chat across 30+ live services with citations, Scenario Engine, Route Explorer, personal AI digest (daily / twice-daily / weekly via Slack, Discord, Telegram, email, webhook), custom widget builder (10 custom dashboards), the Resilience map layer, 500 dashboard-AI requests/day, and MCP access (60 tools under one key, 50 calls/day). Personal license.
