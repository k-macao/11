...
- Real-time global map with 56 data layers, 532+ observed upstream hosts, and 500+ curated news feeds
...
- 60-tool MCP server so AI agents can query everything above
